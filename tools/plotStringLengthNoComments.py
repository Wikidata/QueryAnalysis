...
for j in xrange(1,3):
    ...
    for i in xrange(1, 31):
        if j == 1:
            files.append("stringLengthNoComments/QueryProcessedJena" + "%02d" % i + "StringLengthNoCommentsSpider.tsv")
            type = "Spider"
        elif j == 2:
            files.append("stringLengthNoComments/QueryProcessedJena" + "%02d" % i + "StringLengthNoCommentsUser.tsv")
            type = "User"
    ...
    plotHist(monthly_X, monthly_Y, "QueryProcessedJenaMonthlyLengthNoComments" + type)