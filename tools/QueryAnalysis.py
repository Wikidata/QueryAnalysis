...
parser.add_argument("--threads", "-t", default=5, type=int, help="The number of threads to run the java program with (default 5).")
parser.add_argument("--logging", "-l", help="Enables file logging.", action="store_true")
parser.add_argument("--noBotMetrics", "-b", help="Disables metric calculation for bot queries.", action="store_true")
parser.add_argument("--noDynamicQueryTypes", "-d", help="Disables dynamic generation of query types.", action="store_true")
parser.add_argument("--noGzipOutput", "-g", help="Disables gzipping of the output files.", action="store_true")
parser.add_argument("--noExampleQueriesOutput", "-e", help="Disables the matching of example queries.", action="store_true")
parser.add_argument("--referenceDirectory", "-r", default=unifyQueryTypes.defaultReferenceDirectory, type=str,
                    help="The directory with the reference query types.")
parser.add_argument("--fdupesExecutable", "-f", default=unifyQueryTypes.defaultFdupesExecutable, type=str,
